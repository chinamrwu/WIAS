...
mat <- read.csv("E:/projects/TPD/data/tpdv_tric_protmatrix_181030.csv",stringsAsFactors = F,header = T,check.names =F)
...
write.table(t1,file="E:/projects/TPD/data/TPDV_TRIC_20181115.txt",sep="\t",col.names=T,row.names=T,quote=F)
