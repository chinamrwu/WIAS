...
write.table(predictions,"E:/projects/TPD/results/validation_expert_no_weight.txt",col.names=T,row.names=T,sep="\t",quote=F)
...
write.table(weightPredictions,"E:/projects/TPD/results/validation_expert_weight.txt",col.names=T,row.names=T,sep="\t",quote=F)
