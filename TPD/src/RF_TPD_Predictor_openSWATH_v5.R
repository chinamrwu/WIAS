...
load(file = "E:/projects/TPD/data/RF_TPD_Models_openSWATH_v5.Rdata")
...
write.table(predictions,"E:/projects/TPD/results/validation_openSWATH_no_weight_v5.txt",col.names=T,row.names=T,sep="\t",quote=F)
...
write.table(weightPredictions,"E:/projects/TPD/results/validation_openSWATH_weight_v5.txt",col.names=T,row.names=T,sep="\t",quote=F)
