...
for(lbl in nms){
   ...
   ##########################################  draw ROC plot
	pdf(paste0("E:/projects/TPD/results/RF_TPD_openSWATH_ROC_All_v4_",strTime,".pdf"),width=12)
   ...
   write.table(protScore,file=paste0("E:/projects/TPD/results/geneScores_openSWATH_v4_",strTime,".txt"),sep="\t",quote=F,col.names=T,row.names=F)
   ...
   write.table(result,file=paste0("E:/projects/TPD/results/biomarks_openSWATH_v4_",strTime,"_.txt"),sep="\t",quote=F,col.names=T,row.names=F)
